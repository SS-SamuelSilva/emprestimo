...
if (isset($_GET['submit'])) {
    ...
    if($tabela =='notebook'){
        ...
        $update_sql = "UPDATE $tabela SET identificacao = '$service_tag', nome_detalhado = '$modelo', descricao = '$descricao', processador = '$processador', memora_ram = '$memora_ram', bateria = '$bateria', dominio = '$dominio'";
