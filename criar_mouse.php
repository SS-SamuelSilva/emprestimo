...
if (isset($_POST['submit'])) {
    ...
    $sql_search = "SELECT identificacao, nome_detalhado FROM mouse WHERE identificacao LIKE '$service_tag'";
    ...
    $sql_injection = mysqli_query($con, "INSERT INTO mouse (identificacao, nome_detalhado, descricao) 
...
<body>
    <div class="container">
        ...
        <div class="row g-3">
            <form action="criar_mouse.PHP" method="POST">
                <div class="col-md-3">
